...
- ✅ **Paso 1**: Seleccionar servicio(s) deseado(s)
- ✅ **Paso 2**: Seleccionar profesional (si está habilitado)
  - Ver lista de profesionales disponibles
  - Ver foto, nombre y especialidad de cada uno
  - Opción "Sin preferencia" (cualquier profesional)
  - Filtrar disponibilidad según profesional elegido
- ✅ **Paso 3**: Seleccionar fecha disponible
  - Ver disponibilidad en tiempo real
  - Filtrada por profesional si fue seleccionado
- ✅ **Paso 4**: Seleccionar horario disponible
  - Slots filtrados por profesional
  - Indicar horarios ocupados
- ✅ **Paso 5**: Datos del cliente (si no está logueado)
  - Nombre, email, teléfono
  - Opción de login/registro rápido
- ✅ **Paso 6**: Confirmar y pagar seña
  - Ver resumen completo (servicio, profesional, fecha, hora)
  - Ver precio total
  - Pagar seña con Mercado Pago
- ✅ Agregar notas o comentarios especiales
- ✅ Ver profesional asignado en confirmación
...
- ✅ **Filtrar por profesional** (ver solo turnos de uno)
- ✅ Código de colores por estado
- ✅ Código de colores por servicio
- ✅ **Código de colores por profesional**
- ✅ Drag & drop para mover turnos (entre profesionales)
- ✅ Click para ver detalles del turno
- ✅ Ver profesional asignado en cada turno
...
- ✅ **Asignar profesional** (obligatorio si hay múltiples profesionales)
- ✅ Ver disponibilidad del profesional seleccionado
...
#### 7.1 Profesionales (Múltiples Profesionales por Negocio)

**Configuración**:

- ✅ Toggle "¿Tu negocio tiene varios profesionales?"
- ✅ Toggle "¿Los clientes eligen profesional?" (opcional)
- ✅ Configurar si es obligatorio u opcional elegir profesional

**Gestión de Profesionales**:

- ✅ Lista de profesionales/estilistas del negocio
- ✅ Agregar nuevo profesional al equipo
- ✅ Editar información del profesional
- ✅ Foto de perfil del profesional
- ✅ Especialidades de cada profesional (ej: "Corte y color", "Manicura")
- ✅ Servicios que realiza cada profesional
- ✅ Horarios de trabajo independientes por profesional
- ✅ Días libres y ausencias por profesional
- ✅ Activar/desactivar profesional
- ✅ Ordenar profesionales (prioridad de visualización)

**Casos de Uso**:

- **Peluquería con varios peluqueros**: Cliente elige con quién atenderse
- **Manicura (1 persona)**: No se muestra selección de profesional
- **Spa flexible**: Cliente puede elegir o dejar "sin preferencia"

#### 6.2 Rendimiento del Equipo (Reportes por Profesional)
...
- ✅ Horarios más ocupados por profesional
- ✅ Clientes frecuentes por profesional
